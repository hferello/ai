...
The agent kicks off with a round of clarifying questions (you can skip this if you already know what you want), then scaffolds `features/<your-task>/` with everything it needs to track the work:

- `findings.md`
- `progress.md`
- `documentation.md`
- `prd.md`
- plus **either** a single `task_plan.md` **or** an `overview.md` with per-phase `phase-N-<slug>.md` files when the work is split into phases
