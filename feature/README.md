...
When you’re ready to plan something in a project, say **`/feature`** in Agent chat and follow the prompts. For step-by-step usage, hooks, Windows, or uninstall, see [references/more.md](references/more.md).
